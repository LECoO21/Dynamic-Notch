# 灵动刘海 Website Landing Redesign Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Rebuild the 灵动刘海 marketing site as the approved dark 3D landing page with a magnetic real-product hero, operation marquee, six sticky Tab cards, local-first section, and minimal ending.
