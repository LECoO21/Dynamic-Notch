        ...
        <div className="hero-screen">
          ...
          >
            ...
            >
              ...
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img className="hero-panel-image hero-panel-image-expanded" src={assetPath("/product-captures/home.jpg")} alt="灵动刘海真实首页展开态" />
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img className="hero-panel-image hero-panel-image-collapsed" src={assetPath("/hero/panel-collapsed.png")} alt="灵动刘海真实折叠态" />
              <button
                className="hero-panel-trigger"
                type="button"
                aria-expanded={expanded}
                aria-label={expanded ? "折叠灵动刘海" : "展开灵动刘海"}
