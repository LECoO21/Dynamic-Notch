...
const title = "灵动刘海 — 把 Mac 刘海变成随手工作台";
...
export const metadata: Metadata = {
  ...
  title,
  description,
  applicationName: "灵动刘海",
  keywords: ["灵动刘海", "macOS 刘海", "Mac 待办", "本地工作台", "Apple Silicon"],
  ...
  openGraph: {
    ...
    title,
    description,
    images: [{ url: assetPath("/og.png"), width: 1200, height: 630, alt: "灵动刘海官网分享封面" }],
  },
